...
describe TopicCreator do
  ...
  context "when a language tag is required" do
    before { SiteSetting.multilingual_require_content_language_tag = "yes" }
    ...
    context "when staff are exempt" do
      before { SiteSetting.multilingual_require_content_language_tag = "non-staff" }
  ...
  context "when no language tag is required" do
    before { SiteSetting.multilingual_require_content_language_tag = "no" }
